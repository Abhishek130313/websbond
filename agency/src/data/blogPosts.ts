// ═══════════════════════════════════════════════════════════════════
//  Websbond Blog Posts — Central Data Source
//  Add a new post by adding an object to the `blogPosts` array below.
//  Fields: slug (URL path), title, excerpt, content (HTML), category,
//          date, author, authorRole, readTime, coverImg
// ═══════════════════════════════════════════════════════════════════
...
export const blogPosts: BlogPost[] = [
  {
    slug: "website-banwane-ka-sahi-tarika",
    title: "Website Banwane Ka Sahi Tarika — Jisse Business Sach Me Grow Kare",
    excerpt: "Agar aap apne business ke liye ek professional website banwana chahte hain to yeh guide aapke liye hai. Jaanein kaise ek fast, SEO-friendly website aapke customers ko double kar sakti hai.",
    category: "Web Development",
    date: "June 20, 2024",
    dateISO: "2024-06-20",
    author: "Websbond Team",
    authorRole: "Web Development Experts",
    readTime: "6 min read",
    coverImg: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1200&auto=format&fit=crop&q=80",
    tags: ["website banwaye", "website development", "business website", "website Indore"],
    featured: true,
    content: `
  ...
  {
    slug: "local-seo-indore-google-top",
    title: "Local SEO: Indore Mein Apne Business Ko Google #1 Par Kaise Laayein",
    excerpt: "Google pe 'website developer Indore' ya 'best restaurant Indore' likhne pe aapka business top pe kyun nahi aata? Yeh guide local SEO ke secrets batata hai jo competitors nahi jaante.",
    category: "SEO",
    date: "June 15, 2024",
    dateISO: "2024-06-15",
    author: "Websbond Team",
    ...
    readTime: "7 min read",
    coverImg: "https://images.unsplash.com/photo-1432888622747-4eb9a8efeb07?w=1200&auto=format&fit=crop&q=80",
    tags: ["local SEO", "Google top", "SEO Indore", "business visibility"],
    featured: true,
    content: `
  ...
  {
    slug: "digital-marketing-business-grow",
    title: "Digital Marketing Se Business Kaise Grow Karein — 2024 Complete Guide",
    excerpt: "Facebook Ads, Google Ads, Instagram — in sab mein paisa invest karne se pehle yeh zaroori guide padho. Jaano kaun sa platform aapke business ke liye best hai aur ROI kaise measure karein.",
    category: "Digital Marketing",
    date: "June 10, 2024",
    dateISO: "2024-06-10",
    author: "Websbond Team",
    authorRole: "Digital Marketing Experts",
    readTime: "8 min read",
    coverImg: "https://images.unsplash.com/photo-1611926653458-09294b3142bf?w=1200&auto=format&fit=crop&q=80",
    tags: ["digital marketing", "Google Ads", "Facebook Ads", "business grow"],
    featured: true,
    content: `
  ...
  {
    slug: "react-website-vs-wordpress",
    title: "Custom React Website vs WordPress — Aapke Business Ke Liye Kya Sahi Hai?",
    excerpt: "WordPress sasta lagta hai lekin long-term mein expensive aur risky hai. Jaano kyun ek custom React website aapke business ke liye better investment hai.",
    category: "Web Development",
    date: "June 05, 2024",
    dateISO: "2024-06-05",
    author: "Websbond Team",
    ...
    readTime: "5 min read",
    coverImg: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=1200&auto=format&fit=crop&q=80",
    tags: ["React", "WordPress", "website development", "performance"],
    featured: false,
    content: `
  ...
  },
  {
    ...
    title: "WhatsApp Business Marketing — Free Mein Customers Tak Kaise Pahunchen",
    excerpt: "WhatsApp Business free hai aur India mein sabse effective marketing channel. Jaano kaise WhatsApp se orders, inquiries, aur customer retention badha sakte ho.",
    category: "Digital Marketing",
    date: "May 28, 2024",
    dateISO: "2024-05-28",
    author: "Websbond Team",
    ...
    readTime: "4 min read",
    coverImg: "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=1200&auto=format&fit=crop&q=80",
    tags: ["WhatsApp", "marketing", "business", "customer engagement"],
    featured: false,
    content: `
  ...
  {
    slug: "google-pagespeed-website-ranking",
    title: "Google PageSpeed 100/100 — Kyun Zaroori Hai Aur Kaise Achieve Karein",
    excerpt: "Google slow websites ko rank nahi karta. Jaano PageSpeed score kya hota hai, iska business pe kya impact hai, aur kaise Websbond aapki website ko lightning-fast banata hai.",
    category: "SEO",
    date: "May 20, 2024",
    dateISO: "2024-05-20",
    author: "Websbond Team",
    ...
    readTime: "5 min read",
    coverImg: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&auto=format&fit=crop&q=80",
    tags: ["PageSpeed", "performance", "Core Web Vitals", "Google ranking"],
    featured: false,
    content: `
...
export const getPostsByCategory = (category: string): BlogPost[] =>
  category === "All Posts" ? blogPosts : blogPosts.filter((p) => p.category === category);
