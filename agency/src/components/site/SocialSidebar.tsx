    ...
    {SOCIALS.map((s) => (
      <a
        ...
        style={{
          ...
          boxShadow: `0 0 15px ${s.color}20, inset 0 1px 0 ${s.color}15, 0 4px 12px rgba(0,0,0,0.15)`,
        ...
        onMouseEnter={(e) => {
          ...
          e.currentTarget.style.boxShadow = `0 0 30px ${s.color}60, 0 8px 20px ${s.color}20, inset 0 1px 0 ${s.color}40`;
        ...
        onMouseLeave={(e) => {
          ...
          e.currentTarget.style.boxShadow = `0 0 15px ${s.color}20, inset 0 1px 0 ${s.color}15, 0 4px 12px rgba(0,0,0,0.15)`;
